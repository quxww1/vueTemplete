...
.el-pagination {
  ...
  box-shadow:0px 2px 14px 2px rgba(114,114,114,0.14);
  border-radius:50px;
}
.el-pagination::after,
...
.el-pager li:hover {
  color: rgba(26,156,201,1);
}
.el-pager li.active {
  box-shadow:0px 3px 8px 1px rgba(74,191,232,0.34);
  border-radius:50%;
  color: white;
  cursor: default;
  background-color: rgba(26,156,201,1);
}
